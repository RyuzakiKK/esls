...
\begin{itemize}
 \item sensore ad ultrasuoni \textit{HC-SR04} per rilevare le eventuali auto in transito;
 \item fotoresistenza digitale \textit{TSL2561} per poter regolare l'accensione dei lampioni in base alla luminosità ambientale;
 \item un led per ogni lampione, utilizzati per l'illuminazione stradale.
\end{itemize}
\begin{figure}[tbp]
	\centering
	\includegraphics[width=13cm]{figure/Sketch_rpi.png}
	\caption{Sketch sull'hardware utilizzzato}
\end{figure}
