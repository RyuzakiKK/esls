...
\begin{itemize}
	...
	\item Comunicare ai Raspberry vicini il sopraggiungere di un mezzo sulla carreggiata (solo ad uso interno dei Raspberry stessi) %TODO parlare di questo anche nell'implementazione
\end{itemize}
